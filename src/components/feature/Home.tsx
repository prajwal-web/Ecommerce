...
const Home = () => {
  ...
  const isDesktop1 = useMediaQuery('(min-width:600px)');
  ...
  const HomeComponents = (
    <Box sx={{ position: 'relative', height: 'calc(100vw*0.9)' }}>
      ...
      <Box sx={{ position: 'relative', height: { xs: 'calc(100vw * 0.9)', lg: '90vh', sm: '70vh' } }}>
        <Box
          sx={{
            display: 'flex',
    ...
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
      ...
      <Box sx={{ display: 'flex', gap: '20px' }}>
        {isDesktop1 ? (
          <ProductCard
            title="Latest Drop"
            description="Lorem ipsum, dolor sit amet consectetur adipisicing elit. Veniam, veritatis quas, eum, deleniti quidem expedita laborum porro voluptatem quod voluptatum labore harum error. Molestias nisi eius obcaecati eaque sed quas doloribus ipsum ullam animi corrupti, rerum iusto atque totam iste."
            price={3256.55}
